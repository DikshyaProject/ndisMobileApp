...
TextStyle textStyleLightCustomColor(double fontsize, Color color) {
  return _TextStyleLightCustomColor(fontsize, color);
}
...
TextStyle textStyleBoldBlack(double fontsize, Color black) {
...
TextStyle _TextStyleLightCustomColor(double fontsize, Color colors) {
  return TextStyle(
      fontSize: fontsize,
      color: colors,
      fontStyle: FontStyle.normal,
