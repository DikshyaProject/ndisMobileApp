class LikedListModel {
  String? message;
  List<LikedListData>? data;
  int? status;

  LikedListModel({this.message, this.data, this.status});
  ...
  LikedListModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <LikedListData>[];
      json['data'].forEach((v) {
        data!.add(new LikedListData.fromJson(v));
      });
    }
    status = json['status'];
  }
...
class LikedListData {
  ...
  LikedListData.fromJson(Map<String, dynamic> json) {
