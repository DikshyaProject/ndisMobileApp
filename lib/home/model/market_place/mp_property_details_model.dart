//
// class MPPropertyDetailsModel {
//   String? message;
//   int? status;
//   MpPropertyDetailsData? data;
//
//   MPPropertyDetailsModel({this.message, this.status, this.data});
//
//   MPPropertyDetailsModel.fromJson(Map<String, dynamic> json) {
//     message = json['message'];
//     status = json['status'];
//     data = json['data'] != null ? new MpPropertyDetailsData.fromJson(json['data']) : null;
//   }
//
...
// }
//
// class MpPropertyDetailsData {
//   PropertyDetailsData? propertyDetailsData;
//
//   MpPropertyDetailsData({this.propertyDetailsData});
//
//   MpPropertyDetailsData.fromJson(Map<String, dynamic> json) {
//     propertyDetailsData = json['property_details_data'] != null
//         ? new PropertyDetailsData.fromJson(json['property_details_data'])
//         : null;
//   }
//
//   Map<String, dynamic> toJson() {
//     final Map<String, dynamic> data = new Map<String, dynamic>();
//     if (this.propertyDetailsData != null) {
//       data['property_details_data'] = this.propertyDetailsData!.toJson();
//     }
//     return data;
//   }
// }
...
//         this.subCategory});
//
//   PropertyDetailsData.fromJson(Map<String, dynamic> json) {
...
class MpPropertyDetailsData {
  ...
  MpPropertyDetailsData.fromJson(Map<String, dynamic> json) {
    if (json['property_details_data'] != null) {
      propertyDetailsData = <PropertyDetailsData>[];
      json['property_details_data'].forEach((v) {
        propertyDetailsData!.add(new PropertyDetailsData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.propertyDetailsData != null) {
      data['property_details_data'] =
          this.propertyDetailsData!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class PropertyDetailsData {
  ...
  String? contactEmail;
  String? propertyType;
  String? brochureImage;
  String? suppProLogo;
  String? sdaBuilType;
  String? sdaDesignCategory;
  String? numOfSdaRes;
  String? sdaLocation;
  ...
  PropertyDetailsData.fromJson(Map<String, dynamic> json) {
    ...
    toilet = json['toilet'];
    standardParking = json['standard_parking'];
    ...
    propertyType = json['property_type'];
    brochureImage = json['brochure-image'];
    suppProLogo = json['supp_pro_logo'];
    sdaBuilType = json['sda_buil_type'];
    sdaDesignCategory = json['sda_design_category'];
    numOfSdaRes = json['num_of_sda_res'];
    sdaLocation = json['sda_location'];
    ...
    propFeature = json['prop_feature'].cast<String>();
    nearTrainStat = json['near_train_stat'];
    nearBusStop = json['near_bus_stop'];
    nearTramStop = json['near_tram_stop'];
    nearFerryStat = json['near_ferry_stat'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['standard_parking'] = this.standardParking;
    data['accessible_parking'] = this.accessibleParking;
    data['available'] = this.available;
    data['rent_co_per_week'] = this.rentCoPerWeek;
    data['contact_number'] = this.contactNumber;
    data['contact_email'] = this.contactEmail;
    data['property_type'] = this.propertyType;
    data['brochure-image'] = this.brochureImage;
    data['supp_pro_logo'] = this.suppProLogo;
    data['sda_buil_type'] = this.sdaBuilType;
    data['sda_design_category'] = this.sdaDesignCategory;
    data['num_of_sda_res'] = this.numOfSdaRes;
    data['sda_location'] = this.sdaLocation;
    ...
    data['prop_feature'] = this.propFeature;
    data['near_train_stat'] = this.nearTrainStat;
    data['near_bus_stop'] = this.nearBusStop;
    data['near_tram_stop'] = this.nearTramStop;
    data['near_ferry_stat'] = this.nearFerryStat;
