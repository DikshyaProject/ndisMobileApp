class PsychoSocialModel {
  String? message;
  PsychoSocialData? data;
  int? status;

  PsychoSocialModel({this.message, this.data, this.status});

  PsychoSocialModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    data = json['data'] != null ? new PsychoSocialData.fromJson(json['data']) : null;
    status = json['status'];
  }
...
class PsychoSocialData {
  List<DataList>? dataList;

  PsychoSocialData({this.dataList});

  PsychoSocialData.fromJson(Map<String, dynamic> json) {
