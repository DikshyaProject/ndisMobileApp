// class SupportCoordinatorListModel {
//   String? message;
//   int? status;
//   SupportCoordinatorListData? data;
//
//   SupportCoordinatorListModel({this.message, this.status, this.data});
//
//   SupportCoordinatorListModel.fromJson(Map<String, dynamic> json) {
//     message = json['message'];
//     status = json['status'];
//     data = json['data'] != null ? new SupportCoordinatorListData.fromJson(json['data']) : null;
//   }
//
...
// }
//
// class SupportCoordinatorListData {
//   List<AllSupportCordinatersCatData>? allSupportCordinatersCatData;
//
//   SupportCoordinatorListData({this.allSupportCordinatersCatData});
//
//   SupportCoordinatorListData.fromJson(Map<String, dynamic> json) {
