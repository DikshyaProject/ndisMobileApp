class NdisRegistrationResponseModel {
  NdisRegistrationResponseModel({
  ...
  NdisRegistrationResponseModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  Data({
    required this.NDISRegistration,
  });

  late final NDISRegistrationData NDISRegistration;

  Data.fromJson(Map<String, dynamic> json) {
    NDISRegistration = NDISRegistrationData.fromJson(json['NDIS_registration']);
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['NDIS_registration'] = NDISRegistration.toJson();
    return _data;
  }
}

class NDISRegistrationData {
  NDISRegistrationData({
  ...
  NDISRegistrationData.fromJson(Map<String, dynamic> json) {
    userId = json['user_id'];
    ...
    happyToTravel = json['happyToTravel']??"";
