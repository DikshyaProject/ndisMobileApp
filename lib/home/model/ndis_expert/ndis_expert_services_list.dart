class ServiceExpertListingModel {
  String? message;
  ServiceExpertListingData? data;
  int? status;

  ServiceExpertListingModel({this.message, this.data, this.status});

  ServiceExpertListingModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    data = json['data'] != null ? new ServiceExpertListingData.fromJson(json['data']) : null;
    status = json['status'];
  }
...
class ServiceExpertListingData {
  List<ServiceExpertListing>? serviceExpertListing;

  ServiceExpertListingData({this.serviceExpertListing});

  ServiceExpertListingData.fromJson(Map<String, dynamic> json) {
    if (json['service_expert_listing'] != null) {
      serviceExpertListing = <ServiceExpertListing>[];
      json['service_expert_listing'].forEach((v) {
        serviceExpertListing!.add(new ServiceExpertListing.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.serviceExpertListing != null) {
      data['service_expert_listing'] =
          this.serviceExpertListing!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class ServiceExpertListing {
  String? listingId;
  String? listingCode;
  String? userId;
  String? categoryId;
  ...
  ServiceExpertListing.fromJson(Map<String, dynamic> json) {
