class GeneralRegisterResponseModel {
  ...
  late final GeneralData data;

  GeneralRegisterResponseModel.fromJson(Map<String, dynamic> json){
...
class GeneralData {
  GeneralData({
    required this.generalRegistration,
  });
  late final GeneralRegistration generalRegistration;

  GeneralData.fromJson(Map<String, dynamic> json){
    generalRegistration = GeneralRegistration.fromJson(json['general_registration']);
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['general_registration'] = generalRegistration.toJson();
    return _data;
  }
}
...
class GeneralRegistration {
  ...
  GeneralRegistration.fromJson(Map<String, dynamic> json){
    userId = json['user_id'];
