...
class ServiceDetailsPageModel {
  String? message;
  int? status;
  ServiceDetailsPageData? data;

  ServiceDetailsPageModel({this.message, this.status, this.data});

  ServiceDetailsPageModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    data = json['data'] != null ? new ServiceDetailsPageData.fromJson(json['data']) : null;
  }
...
class ServiceDetailsPageData {
  ListingDetailsData? listingDetailsData;
  List<RelatedThings>? relatedThings;

  ServiceDetailsPageData({this.listingDetailsData, this.relatedThings});

  ServiceDetailsPageData.fromJson(Map<String, dynamic> json) {
    listingDetailsData = json['listing_details_data'] != null
        ? new ListingDetailsData.fromJson(json['listing_details_data'])
        : null;
    if (json['related_things'] != null) {
      relatedThings = <RelatedThings>[];
      json['related_things'].forEach((v) {
        relatedThings!.add(new RelatedThings.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.listingDetailsData != null) {
      data['listing_details_data'] = this.listingDetailsData!.toJson();
    }
    if (this.relatedThings != null) {
      data['related_things'] =
          this.relatedThings!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class ListingDetailsData {
  ...
  String? regGroup;
  String? workHours;
  ApprMerhod? apprMerhod;
  List<String>? language;
  ServSpecilisation? servSpecilisation;
  PetFrie? petFrie;
  String? monIsOpen;
  String? monOpenTime;
  String? monCloseTime;
  ...
  ListingDetailsData.fromJson(Map<String, dynamic> json) {
    listingId = json['listing_id'];
    listingLikesCount = json['listing_likes_count'];
    ...
    apprMerhod = json['appr_merhod'] != null
        ? new ApprMerhod.fromJson(json['appr_merhod'])
        : null;
    language = json['language'].cast<String>();
    servSpecilisation = json['serv_specilisation'] != null
        ? new ServSpecilisation.fromJson(json['serv_specilisation'])
        : null;
    petFrie = json['pet_frie'] != null
        ? new PetFrie.fromJson(json['pet_frie'])
        : null;
    ...
    serDeliMethod = json['ser_deli_method'] != null
        ? new SerDeliMethod.fromJson(json['ser_deli_method'])
        : null;
    ageGroup = json['age_group'] != null
        ? new AgeGroup.fromJson(json['age_group'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['listing_likes_count'] = this.listingLikesCount;
    ...
    if (this.apprMerhod != null) {
      data['appr_merhod'] = this.apprMerhod!.toJson();
    }
    data['language'] = this.language;
    if (this.servSpecilisation != null) {
      data['serv_specilisation'] = this.servSpecilisation!.toJson();
    }
    if (this.petFrie != null) {
      data['pet_frie'] = this.petFrie!.toJson();
    }
    ...
    if (this.serDeliMethod != null) {
      data['ser_deli_method'] = this.serDeliMethod!.toJson();
    }
...
class ApprMerhod {
  ...
  ApprMerhod({this.apprId, this.apprMethod});

  ApprMerhod.fromJson(Map<String, dynamic> json) {
    apprId = json['appr_id'];
    apprMethod = json['appr_method'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['appr_id'] = this.apprId;
    data['appr_method'] = this.apprMethod;
    return data;
  }
}
...
class Language {
  ...
  Language({this.languageName, this.id});
...
class ServSpecilisation {
  String? id;
  String? sName;

  ServSpecilisation({this.id, this.sName});

  ServSpecilisation.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    sName = json['s_name'];
  }
...
class PetFrie {
  ...
  PetFrie({this.petFriId, this.petFriName});

  PetFrie.fromJson(Map<String, dynamic> json) {
...
class SerDeliMethod {
  ...
  SerDeliMethod({this.id, this.sdname});

  SerDeliMethod.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    sdname = json['sdname'];
  }
...
class AgeGroup {
  ...
  AgeGroup({this.suppPreId, this.supportPreferName});
...
class RelatedThings {
  ...
  RelatedThings({this.listingName, this.profileImage});

  RelatedThings.fromJson(Map<String, dynamic> json) {
    listingName = json['listing_name'];
    profileImage = json['profile_image'];
  }
