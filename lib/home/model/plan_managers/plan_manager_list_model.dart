class PlanManagersModel {
  String? message;
  int? status;
  PlanManagerData? data;

  PlanManagersModel({this.message, this.status, this.data});

  PlanManagersModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    status = json['status'];
    data = json['data'] != null ? new PlanManagerData.fromJson(json['data']) : null;
  }
...
class PlanManagerData {
  List<PlanManagerList>? planManagerList;

  PlanManagerData({this.planManagerList});

  PlanManagerData.fromJson(Map<String, dynamic> json) {
    if (json['plan_manager_list'] != null) {
      planManagerList = <PlanManagerList>[];
      json['plan_manager_list'].forEach((v) {
        planManagerList!.add(new PlanManagerList.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.planManagerList != null) {
      data['plan_manager_list'] =
          this.planManagerList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class PlanManagerList {
  String? listingId;
  String? listingCode;
  String? userId;
  String? categoryId;
  ...
  PlanManagerList.fromJson(Map<String, dynamic> json) {
    ...
    if (json['sub_category_name'] != null) {
      subCategoryName = <SubCategoryName>[];
      json['sub_category_name'].forEach((v) {
        subCategoryName!.add(new SubCategoryName.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.subCategoryName != null) {
      data['sub_category_name'] =
          this.subCategoryName!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class SubCategoryName {
  ...
  SubCategoryName.fromJson(Map<String, dynamic> json) {
