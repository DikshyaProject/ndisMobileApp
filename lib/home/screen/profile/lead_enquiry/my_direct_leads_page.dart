...
class MyDirectLeadsPage extends StatefulWidget {
  const MyDirectLeadsPage({super.key});

  @override
  State<MyDirectLeadsPage> createState() => _MyDirectLeadsPageState();
}

class _MyDirectLeadsPageState extends State<MyDirectLeadsPage> {
  DirectLeadsData? data;
  List<VehiclesEnquiryDetailList>? lead_list;
  ...
  void initState() {
    ...
    if (profileState is MyDirectLeadState) {
      data = profileState.directLeadsModel?.data;
      lead_list = data?.vehiclesEnquiryDetailList;
      print("lead_list____${lead_list?.first.emailId}");
    }
    super.initState();
  }
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                    child: Text(
                                  "${lead_list?[index].enquiryMessage}",
