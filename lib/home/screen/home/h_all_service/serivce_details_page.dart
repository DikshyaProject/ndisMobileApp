...
class _HomeServiceDetailsPageState extends State<HomeServiceDetailsPage> {
  ...
  void initState() {
    ...
    if (homeState is HomeServiceDetailsState) {
      ...
      screenType = homeState.screenType!;

      print(screenType+"current screen name ${screenType.runtimeType}");
    }
    if (listingDetailsData!.serviceLocations != null) {
  ...
  Widget build(BuildContext context) {
    return BlocListener<HomeBloc, HomeState>(
      listener: (context, state) {
        print("state_in_service_pro_detail__$state");
        ...
        if (state is GetQuoteSpSuccessState) {
                ...
                onTap: () {
                  if (screenType == "Home") {
                    BlocProvider.of<HomeBloc>(context)
                        .add(HomePopularServicesBackBtnClick());
                  } else {
                    BlocProvider.of<HomeBloc>(context)
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    height: 160.0.scale(),
                    width: 290.0.scale(),
                    padding: EdgeInsets.only(left: 55.0.scale(), right: 10.0.scale()),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          AHorizontalSpace(5.0.scale()),
                          Text(
                            "${listingDetailsData!.listingLikesCount}",
                            textAlign: TextAlign.center,
                            style: textStyleCustomColor(12.0.scale(), Colors.black),
                          ),
                        ],
                    ...
                    GestureDetector(
                      onTap: () {
                        if (sharedPrefs.IsLogin == false) {
                          BlocProvider.of<HomeBloc>(context).add(
                              EventServiceDetailtoLoginBtnClick(screenType == "" ? "service_pro_detail":screenType));
                        } else {
                          print(
        ...
        InkWell(
          onTap: (){
            if (sharedPrefs.IsLogin == true){
              ...
              BlocProvider.of<HomeBloc>(context).add(
                  EventServiceDetailtoLoginBtnClick(widget.screen == "" ? "service_pro_detail": widget.screen));
            }
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            Text(
              listingDetailsData1!.commnRentAss.toString(),
              style: textStyleBlack(12.0.scale()),
            ).leftPadding(5.0.scale()),
            Container(
              decoration: BoxDecoration(
