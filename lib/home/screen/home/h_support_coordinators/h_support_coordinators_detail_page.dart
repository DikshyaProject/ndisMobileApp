...
class SupportCoordinatorDetailsPage extends StatefulWidget {
  const SupportCoordinatorDetailsPage({super.key});

  @override
  State<SupportCoordinatorDetailsPage> createState() =>
      _SupportCoordinatorDetailsPageState();
}

class _SupportCoordinatorDetailsPageState
    extends State<SupportCoordinatorDetailsPage> {
  ...
  void initState() {
    ...
    if (homeState is HomeSupportCoordinatorsDetailPageState) {
    ...
    return BlocListener<HomeBloc, HomeState>(
      ...
      listener: (context, state) {
        ...
        if (state is GetQuoteScoordSuccessState) {
          ...
          BlocProvider.of<HomeBloc>(context).add(HomeSupportCoordinatorDetailClick("${listingDetailsData?.listingId}",screen));
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                      width: 290.0.scale(),
                      padding: EdgeInsets.only(left: 55.0.scale(), right: 10.0.scale(), top: 10.0.scale(), bottom: 10.0.scale()),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      InkWell(
                        onTap: () {
                            if (sharedPrefs.IsLogin == false) {
                              BlocProvider.of<HomeBloc>(context).add(EventSupportCoordToLoginBtnClick(screen == null || screen == '' ?"support_coord_get_quote":"fs_sup_cord"));
                            }else if(!sharedPrefs.userType.contains("Support Worker") && sharedPrefs.IsLogin == true){
                              showSnackBar('Only Support Worker can send enquiry!!', Colors.black, context);
                            }
                            else {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.all(Radius.circular(2)),
                          border: Border.all(color: sharedPrefs.IsLogin == false || !sharedPrefs.userType.contains("Support Worker")?
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              ...
                              textAlign: TextAlign.center,
                              style:
                              textStyleCustomColor(12.0.scale(),
                                  sharedPrefs.IsLogin == false || !sharedPrefs.userType.contains("Support Worker")?
                                      ...
                                      InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            color:
                                            sharedPrefs.IsLogin == false || !sharedPrefs.userType.contains("Support Worker")?
                                            kColorShadowColor.withOpacity(0.1):
                                            kColorShadowColor
                                            ,
                                          ),
                                          child: Text("SEND ENQUIRY ",
                                              style: textStyleBoldCustomLargeColor(10.0.scale(),
                                                sharedPrefs.IsLogin == false || !sharedPrefs.userType.contains("Support Worker")?
                                                Colors.black.withOpacity(0.3):
                                                Colors.black,)).align(Alignment.center),
                                        ),
                                      ),
                                    AVerticalSpace(5.0.scale()),
                                  ],
           ...
           Padding(
             ...
             child: Column(
               children: [
                 ...
                 AVerticalSpace(5.0.scale()),
                 if (claim == true) ClaimList(screen),
        ...
        InkWell(
          onTap: (){
            if (sharedPrefs.IsLogin == true){
              ...
              BlocProvider.of<HomeBloc>(context).add(EventSupportCoordToLoginBtnClick(widget.screen == null || widget.screen == '' ?"support_coord_get_quote":"fs_sup_cord"));
            }
