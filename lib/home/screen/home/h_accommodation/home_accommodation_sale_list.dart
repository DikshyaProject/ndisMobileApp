...
class AccommodationSalealListPage extends StatefulWidget {
  const AccommodationSalealListPage({super.key});

  @override
  State<AccommodationSalealListPage> createState() => _AccommodationSalealListPageState();
}

class _AccommodationSalealListPageState extends State<AccommodationSalealListPage> {
  @override
  ...
  void initState() {
    ...
    if (homeState is HomeAccommodationHousingforSaleState)
    {
