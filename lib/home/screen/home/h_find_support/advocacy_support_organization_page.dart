...
class AdvocacySupportPage extends StatefulWidget {
  const AdvocacySupportPage({super.key});

  @override
  State<AdvocacySupportPage> createState() => _AdvocacySupportPageState();
}

class _AdvocacySupportPageState extends State<AdvocacySupportPage> {
  AdvocacySupportData? data;
  List<DataList>? advocacy_list;
  ...
  void initState() {
    ...
    if (homeState is AdvocacySupportBtnClickState)
    {
      data = homeState.advocacySupportModel?.data;
      advocacy_list = data?.dataList;
      print('advocacy_list___${advocacy_list?.first.listingId}');
    }
    ...
    return BlocListener<HomeBloc, HomeState>(
      ...
      listener: (context, state) {
        if(state is HomeFindSupportPageState){
          ...
          Navigator.of(context).pushNamed(HomeNavigator.hAdvocacyDetailPage);
      ...
      child: SafeArea(
          child: Scaffold(
            ...
            body: ListView.builder(
                itemCount: advocacy_list?.length,
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: ()
                            {
                              ...
                              BlocProvider.of<HomeBloc>(context).add(AdvocacyDetailBtnClick("${advocacy_list?[index].listingId}",));
                            },
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: NetworkImagesWidgets(
                                          url:  "${advocacy_list?[index].profileImage}",
                                          fit: BoxFit.cover, ),
                                      ),
                                    ),
                                    Positioned(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${advocacy_list?[index].listingName}",
                                      maxLines: 2,
                                    ...
                                    Text(
                                      "${advocacy_list?[index].businessTagline}",
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${advocacy_list?[index].listingAddress}",
                                          maxLines:1,
                                          overflow: TextOverflow.ellipsis,
                                          softWrap: true,
                                          style: textStyleCustomColor(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        AHorizontalSpace(4.0.scale()),
                                        Text(  "${advocacy_list?[index].comLandNumber}",
                                          style: textStyleCustomColor(
                                              12.0.scale(), Colors.black),
                                        ),
                                      ],
                                    ...
                                    InkWell(
                                      onTap: (){
                                        if (sharedPrefs.IsLogin){
                                          if(_hasCallSupport){
                                            setState(() {
                                              _launched = _makePhoneCall("${advocacy_list?[index].comLandNumber}");
                                            });
                                          }
                                        }else{
