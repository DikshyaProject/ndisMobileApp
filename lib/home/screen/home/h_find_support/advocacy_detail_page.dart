...
class AdvocacyDetailPage extends StatefulWidget {
  const AdvocacyDetailPage({super.key});

  @override
  State<AdvocacyDetailPage> createState() =>
      _AdvocacyDetailPageState();
}

class _AdvocacyDetailPageState
    extends State<AdvocacyDetailPage> {
  ...
  void initState() {
    ...
    if (homeState is AdvocacyDetailBtnClickState) {
    ...
    return BlocListener<HomeBloc, HomeState>(
      ...
      listener: (context, state) {
        ...
        if (state is GetQuoteScoordSuccessState) {
          ...
          BlocProvider.of<HomeBloc>(context).add(AdvocacyDetailBtnClick("${listingDetailsData?.listingId}"));
                            ...
                            InkWell(
                              onTap: () {
                                if (sharedPrefs.IsLogin == false) {
                                  BlocProvider.of<HomeBloc>(context).add(EventAdvocacyToLoginBtnClick("advocacy_login"));
                                } else {
                                                ...
                                                InkWell(
                                                  onTap: () {
                                                    if (queryController.text.isEmpty) {
                                                      ...
                                                      BlocProvider.of<HomeBloc>(context).add(GetQuoteAdvocacyBtnClick(
                                                        sharedPrefs.userID,
