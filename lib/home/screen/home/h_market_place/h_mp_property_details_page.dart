...
class MpPropertyDetailsPage extends StatefulWidget {
  const MpPropertyDetailsPage({super.key});

  @override
  State<MpPropertyDetailsPage> createState() => _MpPropertyDetailsPageState();
}

class _MpPropertyDetailsPageState extends State<MpPropertyDetailsPage> {
  ...
  void initState() {
    ...
    if(homeState is HomeMpPropertyDetailsState)
    {
      data = homeState.mpPropertyDetailsData;
      propertyDetailsData = data!.propertyDetailsData;
    ...
    return BlocListener<HomeBloc, HomeState>(
      ...
      listener: (context, state) {
        ...
        if (state is GetquotePropSuccessState) {
          ...
          BlocProvider.of<HomeBloc>(context).add(HomeMpPropertyDetailsBtnClick("${propertyDetailsData?.first?.propertyId}"));
                          ...
                          InkWell(
                            onTap: () {
                              if (sharedPrefs.IsLogin == false) {
                                BlocProvider.of<HomeBloc>(context).add(EventPropDetailToLoginBtnClick("mp_prop_detail",
